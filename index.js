...
await client.sendMessage(client.user.id, {
  text: `Hi ${client.user.name},\n\n` +
        `You have connected to *jackal Autoview Bot*.\n\n` +
        `This mini-bot will:\n` +
        ...
        `⚠️ *Note:* This mini-bot is intentionally lightweight — it has *no menus*, *no extra commands*, and *only* the features mentioned above report bugs at *https://stackmorgan.vercel.app/contact.html* ✅.`
});
